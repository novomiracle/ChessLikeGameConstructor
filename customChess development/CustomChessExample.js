let rook = createChessPiecePrototype(
	"rook",
	{
...
let bishop =createChessPiecePrototype("bishop",{
...
let knight = createChessPiecePrototype("knight",{
...
let king = createChessPiecePrototype("king",{
...
let queen = createChessPiecePrototype(
	"queen",
	{
...
let pawn = createChessPiecePrototype("pawn",{
	"white": "https://www.chess.com/chess-themes/pieces/neo/150/wp.png",
	"black": "https://www.chess.com/chess-themes/pieces/neo/150/bp.png"
},false,{condition:(pos,piece)=>{return pos.y == 0 || pos.y == 7},options:[rook,queen,bishop,knight]},[
...
createChessPiece(rook, {x:0,y:7}, "white")
createChessPiece(rook, {x:7,y:7}, "white")
createChessPiece(rook, {x:0,y:0}, "black")
createChessPiece(rook, {x:7,y:0}, "black")
createChessPiece(knight,{x:6,y:7}, "white")
createChessPiece(knight,{x:1,y:7}, "white")
createChessPiece(knight, {x:1,y:0}, "black")
createChessPiece(knight, {x:6,y:0}, "black")
createChessPiece(bishop,{x:2,y:7},"white")
createChessPiece(bishop,{x:5,y:7},"white")
createChessPiece(bishop,{x:2,y:0},"black")
createChessPiece(bishop,{x:5,y:0},"black")
createChessPiece(king,{x:4,y:0},"black")
createChessPiece(king,{x:4,y:7},"white")
createChessPiece(queen, {x:3,y:7}, "white")
createChessPiece(queen, {x:3,y:0}, "black")
for(let i = 0; i < 8; i++){
	createChessPiece(pawn, {x:i,y:6}, "white")
	createChessPiece(pawn, {x:i,y:1}, "black")
}
